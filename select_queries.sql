...
/*11*/
SELECT DISTINCT Χ."ΚωδικόςΧρήστη", Χ."ΌνομαΧρήστη"
FROM ΧΡΗΣΤΗΣ Χ
JOIN ΕΠΙΦΑΝΕΙΑ_ΕΡΓΑΣΙΑΣ ΕΠ ON Χ."ΚωδικόςΧρήστη" = ΕΠ."ΚωδικόςΧρήστη" 
JOIN ΕΠΙΛΕΓΕΙ ΕΠΙ ON ΕΠ."ΚωδικόςΧρήστη" = ΕΠΙ."ΚωδικόςΧρήστη"
JOIN ΡΥΘΜΙΣΗ Ρ ON ΕΠΙ."ΚωδικόςΡύθμισης" = Ρ."ΚωδικόςΡύθμισης"
WHERE Ρ."Περιγραφή" = "Εμφάνιση γραμμής εργαλείων στην επιφάνεια" AND Ρ."Προεπιλογή" = "1"
...
JOIN ΕΠΙΛΕΓΕΙ ΕΠΙ ON ΕΠ."ΚωδικόςΧρήστη" = ΕΠΙ."ΚωδικόςΧρήστη"
JOIN ΡΥΘΜΙΣΗ Ρ ON ΕΠΙ."ΚωδικόςΡύθμισης" = Ρ."ΚωδικόςΡύθμισης"
WHERE Ρ."Περιγραφή" = "Επαναφορά διάταξης μετά από
αλλαγή ανάλυσης" AND Ρ."Προεπιλογή" = "1"

/*12*/
SELECT Χ."ΚωδικόςΧρήστη", Χ."ΌνομαΧρήστη"
FROM ΧΡΗΣΤΗΣ Χ
JOIN ΕΠΙΦΑΝΕΙΑ_ΕΡΓΑΣΙΑΣ ΕΠ ON Χ."ΚωδικόςΧρήστη" = ΕΠ."ΚωδικόςΧρήστη"
JOIN ΕΝΕΡΓΕΙΑ Ε ON ΕΠ."ΌνομαΕπιφάνειας" = Ε."ΌνομαΕπιφάνειας"
GROUP BY Χ."ΚωδικόςΧρήστη", Χ."ΌνομαΧρήστη"
HAVING COUNT(*) = (
    SELECT MAX(Πλήθος)
    FROM (
        SELECT COUNT(*) AS Πλήθος
        FROM ΕΠΙΦΑΝΕΙΑ_ΕΡΓΑΣΙΑΣ ΕΠ2
        JOIN ΕΝΕΡΓΕΙΑ Ε2 ON ΕΠ2."ΌνομαΕπιφάνειας" = Ε2."ΌνομαΕπιφάνειας"
        GROUP BY ΕΠ2."ΚωδικόςΧρήστη"
    )
);
